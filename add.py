...
Traceback (most recent call last):
  ...
  File "/usr/local/lib/python3.10/dist-packages/uvicorn/main.py", line 424, in main
    run(
  ...
  File "/app/services/pipeline.py", line 6, in <module>
    from utils.timers import stopwatch
ImportError: cannot import name 'stopwatch' from 'utils.timers' (/app/utils/timers.py)
